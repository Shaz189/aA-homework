...
View.prototype.exercise5 = function () {
  ...
  $(".square").on("click", el => {
    const clicked = $(el.currentTarget);
    alert(clicked.attr("data-pos"));
  });
  //your code here!
};
...
$(".square").each( (id, el) => {
  let target = $(el);
  target.css("background-color", `rgba( ${Math.random() * 256}, ${Math.random() * 256},${Math.random() * 256}, ${Math.random() * 256})`);
});
